        ...
        <div class="max-w-4xl mx-auto px-4">
            <div class="bg-white rounded-2xl shadow-lg overflow-hidden">
                ...
                <div class="bg-indigo-600 px-8 py-6">
                    <h1 class="text-3xl font-bold text-white">Add New Car</h1>
                ...
                <form action="{{ route('create.car') }}" method="POST" class="p-8 space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="name" placeholder="Toyota"  value="{{ old('name') }}"
                        ...
                        <div>
                            ...
                            <input type="text" name="model" placeholder="Camry"  value="{{ old('model') }}"
                                class="w-full rounded-lg border border-gray-300 px-4 py-3 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 outline-none transition">
                            @error('model')
                                <span class="text-red-500">
                                    {{ $message }}*
                        ...
                        <div>
                            ...
                            <input type="number" name="year" min="1900" max="2100" placeholder="2025"  value="{{ old('year') }}"
                                class="w-full rounded-lg border border-gray-300 px-4 py-3 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 outline-none transition">
                            @error('year')
                                <span class="text-red-500">
                                    {{ $message }}*
                        ...
                        <div>
                            ...
                            <input type="text" name="colour" placeholder="Black"  value="{{ old('colour') }}"
                                class="w-full rounded-lg border border-gray-300 px-4 py-3 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 outline-none transition">
                            @error('colour')
                                <span class="text-red-500">
                                    {{ $message }}*
